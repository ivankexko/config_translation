...
use-utmp = false
#-------------------------------------------------------------------------------
# Следует ли включить поддержку инструмента occt (т.е. либо через DBUS, либо
# через сокет unix).
use-occtl = true
#-------------------------------------------------------------------------------
...
#   dns, nbns, ipv4-network, ipv4-netmask, ipv6-network, ipv6-prefix,
#   rx/tx-per-sec, iroute, route, net-priority и cgroup.
#
